...
Route::prefix('/admin')->group(function () {
    ...
    Route::get('/manage-role', [RoleControlller::class, 'index']);
    Route::get('/manage-role/add', [RoleControlller::class, 'create']);
    Route::post('/manage-role/add', [RoleControlller::class, 'store']);
    Route::delete('/manage-role/{id}', [RoleControlller::class, 'destroy']);
    Route::get('/manage-role/edit/{id}', [RoleControlller::class, 'edit']);
    Route::put('/manage-role/update/{id}', [RoleControlller::class, 'update']);
